...
excerpt: 'Interactive app to easily extract sequences of interest from a reference FASTA file. Click [here](https://lawleyjw.com/bioinformatics/subfasta/) to view the app's code.'
toc: true
---
